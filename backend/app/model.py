...
問題のみを出力すること。
ただし、問題およびユーザーからの想定解答は100文字を超えないように注意する。
ユーザーからの想定解答は出力しないこと。
...
完全正解 (100点)：想定解答の内容とほぼ一致し、重要なポイントを正しく説明している
部分正解 (50～99点)：一部のポイントは正しいが、説明不足や細かい誤りがある
誤答 (0～50点)：主要なポイントが欠落している、または誤った情報が含まれている

## 正しい部分

解答のどの点が想定解答と合致しているかを具体的に指摘。
長くても200文字程度で出力する。
